var luckyNumber = Math.random() * 20; //` * Math.random generates a random number between 0 and 1 and multiply it by 20.
...
function checkNumber() {
  ...
  if (luckyNumber > userNumber) {
    ...
    scoreNumber = scoreNumber - 1;
    score.innerHTML = scoreNumber;
//      instead of innerHTML USING TEXT CONTEXT CAN ALSO CHANGE THE VALUE.
    main.style.backgroundColor = '#D82148';
  }
  if (luckyNumber == userNumber) {
